...
public class PROVAS extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("ENTRA A PROVAS == MAPS");
        ...
        builder.setTitle(R.string.dialog_request_options_title)
                ...
                .setPositiveButton(R.string.button_ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        mLocationManager.removeLocationUpdates(PROVAS.this);
                        mLocationManager.requestLocationUpdates(request, PROVAS.this);
